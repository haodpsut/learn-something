...
'''
(hao_test) userffmpegv2@userffmpegv2:~/hao/working/GT-FID$ python gt_fid_pytorch.py   --data data/adfa_ld.jsonl   --seq_field seq   --vocab data/vocab.json   --device cuda   --epochs 50   --batch_size 32   --num_workers 0
